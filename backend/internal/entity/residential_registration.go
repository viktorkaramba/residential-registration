...
type OSBB struct {
	...
	Poll         []Poll         `gorm:"foreignKey:OSBBID;OnUpdate:CASCADE,OnDelete:CASCADE" json:"polls"`
	Payment      []Payment      `gorm:"foreignKey:OSBBID;OnUpdate:CASCADE,OnDelete:CASCADE" json:"payments"`
